...
import { MapPin, Download, Upload, LogOut, Check, Calendar, Sparkles } from 'lucide-react';
      ...
      <section className="mb-8">
        ...
        <div className="bg-white rounded-xl border border-blush-200 p-4 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-medium text-forest-700">Band Calendar Connected</span>
          </div>
          <p className="text-sm text-forest-400">
            Your weekend competition schedule syncs automatically from Band.
          </p>
          {data.calendarEvents && data.calendarEvents.length > 0 && (
            <div className="mt-3 pt-3 border-t border-blush-100">
              <p className="text-sm text-forest-600">
                {data.calendarEvents.length} events synced
              </p>
            </div>
          )}
        </div>
