...
import { MapPin, Download, Upload, Check, Calendar, Sparkles, RefreshCw, AlertCircle, Cloud, BookOpen, Trophy, ClipboardList, Sun, Moon, Type, Users, Grid3X3, ChevronRight, ArrowLeft, Star, ChevronDown, ChevronUp, Music } from 'lucide-react';
