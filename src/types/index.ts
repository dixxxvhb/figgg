...
// ===== DAILY BRIEFING (Cloud Function bridge) =====

export interface DailyBriefing {
  date: string;                    // "2026-03-21"
  source: 'firebase' | 'cowork';
  enriched: boolean;
  ...
  wellness: {
    lastMoodEntry?: { value: number; timestamp: string };
...
export interface AppData {
  ...
  grief?: GriefData;
  // Daily briefing (generated by Cloud Function at 5:30am)
